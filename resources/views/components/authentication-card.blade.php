...
<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-white dark:bg-neutral-900 dark:border-neutral-700">
    <div class="p-4 sm:p-7 lg:w-[500px] border border-gray-200 rounded-xxl shadow-sm ">
